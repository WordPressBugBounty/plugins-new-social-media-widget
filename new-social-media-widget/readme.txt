...
Need a simple way to display social media icon links on your site? This lightweight widget makes it easy to add profile icons for all your favorite platforms right in your sidebar, footer, or any widget area.
...
Whether you run a blog, business site, or portfolio, having visible social media icon links helps visitors connect with you across platforms. This widget gives you full control over icon styles, colors, spacing, and animations without touching any code.

= Why Use This Social Media Icon Widget? =

Setting up social icons shouldn't be complicated. With this widget, you simply drag it to your widget area, add your profile URLs, pick your colors, and you're done. Each social media icon looks sharp on any screen size and blends naturally with your theme.

= Supported Platforms =

Connect your audience to these popular networks:

* Facebook, X (Twitter), Instagram, YouTube
* Pinterest, LinkedIn, Snapchat, TikTok
* Tumblr, Flickr, Vimeo, Reddit
* RSS Feed, Email, WhatsApp, Telegram
* And many more in the premium version

= What Makes This Social Media Icon Widget Different =

Unlike bloated social sharing toolbars, this widget focuses on one thing: displaying your social media icon links beautifully. It loads fast, works with any theme, and gives you creative freedom through customization options.

You can adjust each social media icon color to match your brand, add hover effects for visual feedback, and even apply rotation transforms for a unique touch. The spacing controls help you create the exact layout you want.

= Free Features =

* 12 popular social network icons
...
Enhance your website with these powerful addons:
...
[Check Premium Version](https://awplife.com/wordpress-plugins/weather-effect-premium/) – Access multiple effects and settings.
...
[Check Premium Version](https://awplife.com/wordpress-plugins/photo-gallery-premium/) – Advanced gallery features.
...
1. Upload the plugin files to `/wp-content/plugins/new-social-media-widget/` directory, or install through the Plugins screen.
2. Activate the plugin through the Plugins menu.
3. Go to Appearance > Widgets in your dashboard.
4. Drag the Social Media Icon Widget to your preferred widget area.
5. Add your social profile URLs and customize the appearance.
6. Save and check your site.

== Frequently Asked Questions ==

= How do I add the widget to my sidebar? =
...
The free version includes 12 popular platforms like Facebook, X (Twitter), Instagram, YouTube, Pinterest, LinkedIn, and more. The premium version supports 30+ platforms including TikTok, Discord, Telegram, and others.

= Do the links open in a new tab? =

Yes, all social profile links open in a new browser tab by default, keeping visitors on your site.

= Can I add custom CSS styles? =

Absolutely. The widget includes a custom CSS field where you can add your own styling rules for complete control over the appearance.

= Is the widget mobile responsive? =

Yes, the icons automatically adjust to look great on phones, tablets, and desktop screens.

= How do I add hover effects? =

In the widget settings, you'll find hover effect options. The free version includes basic hover color changes, while the premium version offers 60+ animation effects.

= What's the difference between free and premium? =

The free version covers essential needs with 12 icons and basic customization. Premium adds 30+ platforms, 60+ hover effects, 10+ transform effects, and advanced styling options.

= Can I use multiple widgets on one page? =

Yes, you can add the widget to multiple areas like sidebar, footer, and header simultaneously. Each instance can have different settings.

= Does this work with page builders? =

The widget works with any theme that supports standard widget areas. It's compatible with Elementor, Beaver Builder, and other page builders.

= How do I get support? =

For questions or issues, post on the plugin support forum and our team will assist you.

== Screenshots ==
1. Hover Effect Animation 1 (in pro)
2. Hover Effect Animation 2 (in pro)
3. Hover Effect Animation 3 (in pro)
4. Hover Effect Animation 4 (in pro)
5. Social Settings Panel
6. Social Profile Configuration
7. Widget Design & Effect Options
...
= 1.2.9 =
* Bug fixes
* Tested with version 6.8.2

= 1.2.8 =
* Bug fixes
* Tested with version 6.8.1

= 1.2.7 =
* Bug fixes
* Tested with version 6.7.2
